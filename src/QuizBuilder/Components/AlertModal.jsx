    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm">
      <div className="relative w-full max-w-sm rounded-2xl bg-white p-6 shadow-2xl dark:bg-zinc-900">
        ...
        <div className="flex flex-col items-center text-center">
          {/* Alert Icon */}
          <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-yellow-500/10">
          ...
          {/* Message */}
          <p className="mt-2 max-w-xs text-sm leading-5 text-zinc-500 dark:text-zinc-400">
            {message}
          </p>
